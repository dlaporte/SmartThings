 ...
 *
 *   2017-02-12: v1.11
 *    - enabled httpGet, corrected incorrect HTTP response code (David LaPorte)
 *
 *   2017-01-30: v1.10
...
def postToInfluxDB(data) {
    ...
    if (state.databasePassword != "") {
      url += "&u=${state.databaseLogin}&p=${state.databasePassword}"
    }
    def params = [
		uri: url,
		body: data
...
private getGroupName(id) {
    ...
    else if (id == '4f15dd76-0b6e-4e79-a032-1a06f2156694') {return 'Downstairs'}
    else if (id == '85dbac3d-7966-4c7f-8184-1ef3bd9d8058') {return 'Loft'}
    else if (id == '992ef903-21f9-4d2b-bb3c-923d55fb1495') {return 'Upstairs'}
    else if (id == 'eb346b9e-f751-4b31-8fc7-88a731732e66') {return 'Outside'}
    else {return 'Unknown'}     
}
